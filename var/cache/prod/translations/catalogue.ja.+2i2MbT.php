...
',
  ...
  array (
    ...
    'common.postal_code_sample' => '例：5530003',
    'common.search_postal_code' => '郵便番号検索',
    'common.address_sample_01' => '市区町村名(例：大阪府大阪市福島区)',
    'common.address_sample_02' => '番地・ビル名(例：福島8丁目3-15)',
...
',
    ...
    'admin.common.postal_code_sample' => '例：5530003',
    'admin.common.address_sample_01' => '市区町村名(例：大阪府大阪市福島区)',
    'admin.common.address_sample_02' => '番地・ビル名(例：福島8丁目3-15)',
    ...
    'admin.product.product_class__reset_confirm_message' => 'この商品に登録された規格を初期化します。 これまでの販売データには影響はありませんが、この操作は取り消すことができません。 初期化しますか？',
    ...
    'admin.product.category_id' => 'カテゴリID 既存カテゴリの更新はカテゴリIDを設定',
...
',
    ...
    'admin.setting.system.authority.description' => '%url%以降からのURLを拒否URLに入力してください。 拒否URL以降がアクセス拒否されます。(URLは前方一致)',
...
',
    ...
    'tooltip.order.order_status' => '受注の対応状況を変更できます。ただし、新規受注登録の場合は対応状況の。また、1受注で出荷先が複数ある場合は、全て出荷されると対応状況が「出荷済」となります。',
