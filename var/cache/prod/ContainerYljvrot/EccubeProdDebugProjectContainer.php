 ...
 */
class EccubeProdDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'doctrine.orm.default_second_level_cache.logger_chain' => 'getDoctrine_Orm_DefaultSecondLevelCache_LoggerChainService.php',
            'doctrine.orm.default_second_level_cache.logger_statistics' => 'getDoctrine_Orm_DefaultSecondLevelCache_LoggerStatisticsService.php',
            ...
            'security.request_matcher.pkaje2h' => 'getSecurity_RequestMatcher_Pkaje2hService.php',
        ...
        $this->privates = array(
            ...
            'security.request_matcher.pkaje2h' => true,
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->getDoctrine_Dbal_ConnectionFactoryService()) && false ?: '_'}->createConnection(array('driver' => 'pdo_sqlite', 'charset' => 'utf8', 'url' => $this->getEnv('resolve:DATABASE_URL'), 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => array(), 'serverVersion' => $this->getEnv('DATABASE_SERVER_VERSION'), 'defaultTableOptions' => array('collate' => 'utf8_general_ci')), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a = ${($_ = isset($this->services['doctrine.app_cache_provider']) ? $this->services['doctrine.app_cache_provider'] : $this->getDoctrine_AppCacheProviderService()) && false ?: '_'};
        ...
        $d->setCacheLogger($c);
        $d->setCacheFactory(new \Doctrine\ORM\Cache\DefaultCacheFactory(${($_ = isset($this->services['doctrine.orm.default_second_level_cache.regions_configuration']) ? $this->services['doctrine.orm.default_second_level_cache.regions_configuration'] : $this->services['doctrine.orm.default_second_level_cache.regions_configuration'] = new \Doctrine\ORM\Cache\RegionsConfiguration()) && false ?: '_'}, $a));
        $d->setRegionsConfiguration(new \Doctrine\ORM\Cache\RegionsConfiguration());

        $e = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, array(0 => ($this->targetDirs[3].'/src/Eccube/Entity')));
        ...
        $f->addDriver($e, 'Eccube\\Entity');
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, array(0 => ($this->targetDirs[3].'/app/Customize/Entity'))), 'Customize\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array());
        $g->setSecondLevelCacheEnabled(true);
        $g->setSecondLevelCacheConfiguration($d);
        $g->setMetadataCacheImpl($a);
        $g->setQueryCacheImpl($a);
        $g->setResultCacheImpl($a);
        ...
        $g->setEntityListenerResolver(${($_ = isset($this->services['doctrine.orm.default_entity_listener_resolver']) ? $this->services['doctrine.orm.default_entity_listener_resolver'] : $this->services['doctrine.orm.default_entity_listener_resolver'] = new \Doctrine\Bundle\DoctrineBundle\Mapping\ContainerAwareEntityListenerResolver($this)) && false ?: '_'});
        $g->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('Eccube\\Repository\\AuthorityRoleRepository' => function () {
        ...
        $g->addCustomStringFunction('NORMALIZE', 'Eccube\\Doctrine\\ORM\\Query\\Normalize');
        $g->addCustomNumericFunction('EXTRACT', 'Eccube\\Doctrine\\ORM\\Query\\Extract');
        $g->addFilter('option_nostock_hidden', 'Eccube\\Doctrine\\Filter\\NoStockHiddenFilter');
        $g->addFilter('incomplete_order_status_hidden', 'Eccube\\Doctrine\\Filter\\OrderStatusFilter');

        $instance = \Doctrine\ORM\EntityManager::create(${($_ = isset($this->services['doctrine.dbal.default_connection']) ? $this->services['doctrine.dbal.default_connection'] : $this->getDoctrine_Dbal_DefaultConnectionService()) && false ?: '_'}, $g);
    ...
    {
        return $this->services['state_machine.order'] = new \Symfony\Component\Workflow\StateMachine(new \Symfony\Component\Workflow\Definition(array(0 => '1', 1 => '3', 2 => '4', 3 => '5', 4 => '6', 5 => '7', 6 => '8', 7 => '9'), array(0 => new \Symfony\Component\Workflow\Transition('pay', '1', '6'), 1 => new \Symfony\Component\Workflow\Transition('packing', '1', '4'), 2 => new \Symfony\Component\Workflow\Transition('packing', '6', '4'), 3 => new \Symfony\Component\Workflow\Transition('cancel', '1', '3'), 4 => new \Symfony\Component\Workflow\Transition('cancel', '4', '3'), 5 => new \Symfony\Component\Workflow\Transition('cancel', '6', '3'), 6 => new \Symfony\Component\Workflow\Transition('back_to_in_progress', '3', '4'), 7 => new \Symfony\Component\Workflow\Transition('ship', '1', '5'), 8 => new \Symfony\Component\Workflow\Transition('ship', '6', '5'), 9 => new \Symfony\Component\Workflow\Transition('ship', '4', '5'), 10 => new \Symfony\Component\Workflow\Transition('return', '5', '9'), 11 => new \Symfony\Component\Workflow\Transition('cancel_return', '9', '5')), '1'), new \Symfony\Component\Workflow\MarkingStore\SingleStateMarkingStore('status'), ${($_ = isset($this->services['debug.event_dispatcher']) ? $this->services['debug.event_dispatcher'] : $this->getDebug_EventDispatcherService()) && false ?: '_'}, 'order');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->getTwig_LoaderService()) && false ?: '_'}, array('paths' => array(($this->targetDirs[3].'/app/template/'.$this->getEnv('string:ECCUBE_TEMPLATE_CODE')) => NULL, ($this->targetDirs[3].'/src/Eccube/Resource/template/default') => NULL, ($this->targetDirs[3].'/app/Plugin') => NULL, ($this->targetDirs[3].'/app/template/admin') => 'admin', ($this->targetDirs[3].'/src/Eccube/Resource/template/admin') => 'admin', ($this->targetDirs[3].'/app/template/user_data') => 'user_data', ($this->targetDirs[3].'/src/Eccube/Resource/template/toolbar') => 'toolbar', ($this->targetDirs[3].'/src/Eccube/Resource/template/common') => 'common'), 'debug' => true, 'strict_variables' => true, 'form_themes' => $this->parameters['twig.form.resources'], 'date' => array('timezone' => $this->getEnv('ECCUBE_TIMEZONE'), 'format' => 'F j, Y H:i', 'interval_format' => '%d days'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'default_path' => ($this->targetDirs[3].'/templates'), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Eccube\Twig\Extension\EccubeBlockExtension($instance, array()));
    ...
    protected function getEnvironmentService()
    {
        ...
        return $this->services['Eccube\Twig\Environment'] = new \Eccube\Twig\Environment($a, ${($_ = isset($this->services['debug.event_dispatcher']) ? $this->services['debug.event_dispatcher'] : $this->getDebug_EventDispatcherService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['Monolog\Processor\IntrospectionProcessor'] = new \Monolog\Processor\IntrospectionProcessor('!php/const:Monolog\\Logger::DEBUG', array(0 => 'Eccube\\\\Log', 1 => 'Psr\\\\Log'));
    }
    ...
    {
        return $this->services['Symfony\Bridge\Monolog\Processor\WebProcessor'] = new \Symfony\Bridge\Monolog\Processor\WebProcessor(array('url' => 'REQUEST_URI', 'ip' => 'REMOTE_ADDR', 'http_method' => 'REQUEST_METHOD', 'server' => 'SERVER_NAME', 'referrer' => 'HTTP_REFERER', 'user_agent' => 'HTTP_USER_AGENT'));
    }
    ...
    {
        $a = ${($_ = isset($this->services['assets.context']) ? $this->services['assets.context'] : $this->getAssets_ContextService()) && false ?: '_'};

        $b = new \Symfony\Component\Asset\VersionStrategy\EmptyVersionStrategy();

        return $this->services['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('/html/template/'.$this->getEnv('string:ECCUBE_TEMPLATE_CODE'), $b, $a), array('admin' => new \Symfony\Component\Asset\PathPackage('/html/template/admin', $b, $a), 'save_image' => new \Symfony\Component\Asset\PathPackage('/html/upload/save_image', $b, $a), 'plugin' => new \Symfony\Component\Asset\PathPackage('/html/template/plugin', $b, $a), 'install' => new \Symfony\Component\Asset\PathPackage('/html/template/install', $b, $a), 'temp_image' => new \Symfony\Component\Asset\PathPackage('/html/upload/temp_image', $b, $a)));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('form.pre_bind', array(0 => function () {
        ...
        $instance->addListener('workflow.order.completed', array(0 => function () {
        ...
        $instance->addListener('workflow.order.transition.pay', array(0 => function () {
            return ${($_ = isset($this->services['Eccube\Service\OrderStateMachine']) ? $this->services['Eccube\Service\OrderStateMachine'] : $this->load('getOrderStateMachineService.php')) && false ?: '_'};
        }, 1 => 'updatePaymentDate'), 0);
        $instance->addListener('workflow.order.transition.cancel', array(0 => function () {
            return ${($_ = isset($this->services['Eccube\Service\OrderStateMachine']) ? $this->services['Eccube\Service\OrderStateMachine'] : $this->load('getOrderStateMachineService.php')) && false ?: '_'};
        }, 1 => 'rollbackStock'), 0);
        $instance->addListener('workflow.order.transition.cancel', array(0 => function () {
            return ${($_ = isset($this->services['Eccube\Service\OrderStateMachine']) ? $this->services['Eccube\Service\OrderStateMachine'] : $this->load('getOrderStateMachineService.php')) && false ?: '_'};
        }, 1 => 'rollbackUsePoint'), 0);
        $instance->addListener('workflow.order.transition.back_to_in_progress', array(0 => function () {
            return ${($_ = isset($this->services['Eccube\Service\OrderStateMachine']) ? $this->services['Eccube\Service\OrderStateMachine'] : $this->load('getOrderStateMachineService.php')) && false ?: '_'};
        }, 1 => 'commitStock'), 0);
        $instance->addListener('workflow.order.transition.back_to_in_progress', array(0 => function () {
            return ${($_ = isset($this->services['Eccube\Service\OrderStateMachine']) ? $this->services['Eccube\Service\OrderStateMachine'] : $this->load('getOrderStateMachineService.php')) && false ?: '_'};
        }, 1 => 'commitUsePoint'), 0);
        $instance->addListener('workflow.order.transition.ship', array(0 => function () {
            return ${($_ = isset($this->services['Eccube\Service\OrderStateMachine']) ? $this->services['Eccube\Service\OrderStateMachine'] : $this->load('getOrderStateMachineService.php')) && false ?: '_'};
        }, 1 => 'commitAddPoint'), 0);
        $instance->addListener('workflow.order.transition.return', array(0 => function () {
            return ${($_ = isset($this->services['Eccube\Service\OrderStateMachine']) ? $this->services['Eccube\Service\OrderStateMachine'] : $this->load('getOrderStateMachineService.php')) && false ?: '_'};
        }, 1 => 'rollbackUsePoint'), 0);
        $instance->addListener('workflow.order.transition.return', array(0 => function () {
            return ${($_ = isset($this->services['Eccube\Service\OrderStateMachine']) ? $this->services['Eccube\Service\OrderStateMachine'] : $this->load('getOrderStateMachineService.php')) && false ?: '_'};
        }, 1 => 'rollbackAddPoint'), 0);
        $instance->addListener('workflow.order.transition.cancel_return', array(0 => function () {
            return ${($_ = isset($this->services['Eccube\Service\OrderStateMachine']) ? $this->services['Eccube\Service\OrderStateMachine'] : $this->load('getOrderStateMachineService.php')) && false ?: '_'};
        }, 1 => 'commitUsePoint'), 0);
        $instance->addListener('workflow.order.transition.cancel_return', array(0 => function () {
            return ${($_ = isset($this->services['Eccube\Service\OrderStateMachine']) ? $this->services['Eccube\Service\OrderStateMachine'] : $this->load('getOrderStateMachineService.php')) && false ?: '_'};
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', 1)) && false ?: '_'}, ($this->targetDirs[3].'\\src\\Eccube/Resources'), array(0 => ($this->targetDirs[3].'\\src\\Eccube')));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.admin' => function () {
            ...
            yield 'security.firewall.map.context.admin' => ${($_ = isset($this->services['security.request_matcher.pkaje2h']) ? $this->services['security.request_matcher.pkaje2h'] : $this->services['security.request_matcher.pkaje2h'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')) && false ?: '_'};
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator(${($_ = isset($this->services['file_locator']) ? $this->services['file_locator'] : $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', 1)) && false ?: '_'}, ($this->targetDirs[3].'\\src\\Eccube/Resources'), array(0 => ($this->targetDirs[3].'\\src\\Eccube')))) && false ?: '_'}, $this->targetDirs[0]);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'session.storage.options': $value = array(
                'cache_limiter' => '0',
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/EccubeProdDebugProjectContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'EccubeProdDebugProjectContainer',
            'env(DATABASE_URL)' => '',
            ...
            'eccube_twig_block_templates' => array(
            ...
            'eccube_tax_rule_priority' => array(
                0 => 'product_id',
                1 => 'product_class_id',
                2 => 'pref_id',
                3 => 'country_id',
            ...
            'eccube.plugins.enabled' => array(

            ),
            'eccube.plugins.disabled' => array(
            ...
            'router.options.matcher.cache_class' => 'EccubeProdDebugProjectContainerUrlMatcher',
            'router.options.generator.cache_class' => 'EccubeProdDebugProjectContainerUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => 'kernel:loadRoutes',
            'router.cache_class_prefix' => 'EccubeProdDebugProjectContainer',
