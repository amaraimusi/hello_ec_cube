...
class EccubeProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'security.request_matcher.un8kq_i' => 'getSecurity_RequestMatcher_Un8kqIService.php',
        ...
        $this->privates = array(
            ...
            'security.request_matcher.un8kq_i' => true,
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Cache\CacheConfiguration();
        $c->setCacheFactory(new \Doctrine\ORM\Cache\DefaultCacheFactory(${($_ = isset($this->services['doctrine.orm.default_second_level_cache.regions_configuration']) ? $this->services['doctrine.orm.default_second_level_cache.regions_configuration'] : $this->services['doctrine.orm.default_second_level_cache.regions_configuration'] = new \Doctrine\ORM\Cache\RegionsConfiguration()) && false ?: '_'}, $a));
        $c->setRegionsConfiguration(new \Doctrine\ORM\Cache\RegionsConfiguration());

        $d = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, array(0 => ($this->targetDirs[3].'/src/Eccube/Entity')));
        ...
        $e->addDriver($d, 'Eccube\\Entity');
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, array(0 => ($this->targetDirs[3].'/app/Customize/Entity'))), 'Customize\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array());
        $f->setSecondLevelCacheEnabled(true);
        $f->setSecondLevelCacheConfiguration($c);
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($a);
        $f->setResultCacheImpl($a);
        ...
        $f->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('Eccube\\Repository\\AuthorityRoleRepository' => function () {
        ...
        $f->addCustomStringFunction('NORMALIZE', 'Eccube\\Doctrine\\ORM\\Query\\Normalize');
        $f->addCustomNumericFunction('EXTRACT', 'Eccube\\Doctrine\\ORM\\Query\\Extract');
        $f->addFilter('option_nostock_hidden', 'Eccube\\Doctrine\\Filter\\NoStockHiddenFilter');
        $f->addFilter('incomplete_order_status_hidden', 'Eccube\\Doctrine\\Filter\\OrderStatusFilter');

        $instance = \Doctrine\ORM\EntityManager::create(${($_ = isset($this->services['doctrine.dbal.default_connection']) ? $this->services['doctrine.dbal.default_connection'] : $this->getDoctrine_Dbal_DefaultConnectionService()) && false ?: '_'}, $f);
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->getTwig_LoaderService()) && false ?: '_'}, array('paths' => array(($this->targetDirs[3].'/app/template/'.$this->getEnv('string:ECCUBE_TEMPLATE_CODE')) => NULL, ($this->targetDirs[3].'/src/Eccube/Resource/template/default') => NULL, ($this->targetDirs[3].'/app/Plugin') => NULL, ($this->targetDirs[3].'/app/template/admin') => 'admin', ($this->targetDirs[3].'/src/Eccube/Resource/template/admin') => 'admin', ($this->targetDirs[3].'/app/template/user_data') => 'user_data', ($this->targetDirs[3].'/src/Eccube/Resource/template/toolbar') => 'toolbar', ($this->targetDirs[3].'/src/Eccube/Resource/template/common') => 'common'), 'debug' => false, 'strict_variables' => false, 'form_themes' => $this->parameters['twig.form.resources'], 'date' => array('timezone' => $this->getEnv('ECCUBE_TIMEZONE'), 'format' => 'F j, Y H:i', 'interval_format' => '%d days'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'default_path' => ($this->targetDirs[3].'/templates'), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    protected function getSecurity_FirewallService()
    {
        return $this->services['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.admin' => function () {
            ...
            yield 'security.firewall.map.context.admin' => ${($_ = isset($this->services['security.request_matcher.un8kq_i']) ? $this->services['security.request_matcher.un8kq_i'] : $this->services['security.request_matcher.un8kq_i'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')) && false ?: '_'};
