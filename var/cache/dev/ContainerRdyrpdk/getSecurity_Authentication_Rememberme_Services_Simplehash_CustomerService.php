...
return $this->services['security.authentication.rememberme.services.simplehash.customer'] = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => ${($_ = isset($this->services['Eccube\Security\Core\User\CustomerProvider']) ? $this->services['Eccube\Security\Core\User\CustomerProvider'] : $this->load('getCustomerProviderService.php')) && false ?: '_'}), $this->getEnv('ECCUBE_AUTH_MAGIC'), 'customer', array('lifetime' => 3600, 'name' => 'eccube_remember_me', 'remember_me_parameter' => 'login_memory', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false), ${($_ = isset($this->services['monolog.logger.security']) ? $this->services['monolog.logger.security'] : $this->load('getMonolog_Logger_SecurityService.php')) && false ?: '_'});
