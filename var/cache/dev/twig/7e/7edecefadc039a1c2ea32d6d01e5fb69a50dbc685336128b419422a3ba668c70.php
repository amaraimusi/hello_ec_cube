...
class __TwigTemplate_d3925a94a3616010ee7d092f49b2ac6e4c30059dc4bf4726b79850264ccc2b6b extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@MobileDetect/Collector/device.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@MobileDetect/Collector/device.html.twig"));
    ...
    ";
        ...
        if (((isset($context["profiler_markup_version"]) || array_key_exists("profiler_markup_version", $context) ? $context["profiler_markup_version"] : (function () { throw new Twig_Error_Runtime('Variable "profiler_markup_version" does not exist.', 6, $this->source); })()) > 1)) {
            ...
            // line 12
            echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new Twig_Error_Runtime('Variable "collector" does not exist.', 12, $this->source); })()), "currentView", array())), "html", null, true);
            echo "</span>
        ";
            ...
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new Twig_Error_Runtime('Variable "collector" does not exist.', 21, $this->source); })()), "views", array()));
            foreach ($context['_seq'] as $context["_key"] => $context["viewData"]) {
                ...
                // line 23
                echo "                ";
                if (twig_get_attribute($this->env, $this->source, $context["viewData"], "isCurrent", array())) {
                    // line 24
                    echo "                    ";
                    $context["viewLink"] = "<span class=\"sf-toolbar-status sf-toolbar-status-green\">current</span>";
                    // line 25
                    echo "                ";
                } elseif ((twig_get_attribute($this->env, $this->source, $context["viewData"], "enabled", array()) == false)) {
                    // line 26
                    echo "                    ";
                    ...
                    // line 28
                    echo "                    ";
                    $context["viewLink"] = (("<span><a href=\"" . twig_get_attribute($this->env, $this->source, $context["viewData"], "link", array())) . "\">Use this view</a></span>");
                    // line 29
                    echo "                ";
                }
                // line 30
                echo "                <div class=\"sf-toolbar-info-piece\">
                    <b>";
                // line 31
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["viewData"], "label", array()), "html", null, true);
                echo "</b>
                    ";
                // line 32
                echo (isset($context["viewLink"]) || array_key_exists("viewLink", $context) ? $context["viewLink"] : (function () { throw new Twig_Error_Runtime('Variable "viewLink" does not exist.', 32, $this->source); })());
                echo "
                </div>
            ";
            }
            ...
            View: ";
            // line 42
            echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new Twig_Error_Runtime('Variable "collector" does not exist.', 42, $this->source); })()), "currentView", array())), "html", null, true);
            echo "
            </span>
        ";
            $context["icon"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
            ...
            // line 58
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new Twig_Error_Runtime('Variable "collector" does not exist.', 58, $this->source); })()), "views", array()));
            foreach ($context['_seq'] as $context["_key"] => $context["viewData"]) {
                // line 59
                echo "                        ";
                $context["viewLink"] = "";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["viewData"], "isCurrent", array())) {
                    ...
                    // line 65
                    echo "                            ";
                    $context["viewLink"] = (("<a href=\"" . twig_get_attribute($this->env, $this->source, $context["viewData"], "link", array())) . "\">Use this view</a>");
                    // line 66
                    echo "                        ";
                }
                // line 67
                ...
                echo "</td>
                            <td>";
                // line 69
                echo (isset($context["viewLink"]) || array_key_exists("viewLink", $context) ? $context["viewLink"] : (function () { throw new Twig_Error_Runtime('Variable "viewLink" does not exist.', 69, $this->source); })());
                echo "</td>
                        </tr>
                    ";
            }
    ...
    ";
        ...
        // line 98
        echo "    ";
        $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "@MobileDetect/Collector/device.html.twig", 98)->display(array_merge($context, array("link" => false)));
    ...
    {
        return array (  243 => 98,  219 => 76,  213 => 72,  204 => 69,  200 => 68,  197 => 67,  194 => 66,  191 => 65,  188 => 64,  185 => 63,  182 => 62,  179 => 61,  176 => 60,  173 => 59,  169 => 58,  155 => 46,  152 => 45,  146 => 42,  141 => 39,  138 => 38,  136 => 37,  133 => 36,  130 => 35,  121 => 32,  117 => 31,  114 => 30,  111 => 29,  108 => 28,  105 => 27,  102 => 26,  99 => 25,  96 => 24,  93 => 23,  90 => 22,  86 => 21,  78 => 15,  75 => 14,  70 => 12,  64 => 8,  61 => 7,  58 => 6,  56 => 5,  53 => 4,  44 => 3,  15 => 1,);
    }
...
{% endblock %}
", "@MobileDetect/Collector/device.html.twig", "C:\\Users\\user\\git\\hello_ec_cube\\vendor\\suncat\\mobile-detect-bundle\\SunCat\\MobileDetectBundle\\Resources\\views\\Collector\\device.html.twig");
    }
}
