    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/_')) {
            ...
            if (0 === strpos($pathinfo, '/_error') && preg_match('#^/_error/(?P<code>\\d+)(?:\\.(?P<_format>[^/]++))?$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => '_twig_error_test')), array (  '_controller' => 'twig.controller.preview_error:previewErrorPageAction',  '_format' => 'html',));
            ...
            if (0 === strpos($pathinfo, '/_wdt') && preg_match('#^/_wdt/(?P<token>[^/]++)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => '_wdt')), array (  '_controller' => 'web_profiler.controller.profiler:toolbarAction',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
                        goto not__wdt;
            ...
            if (0 === strpos($pathinfo, '/_profiler')) {
                ...
                if (preg_match('#^/_profiler/(?P<token>[^/]++)/search/results$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => '_profiler_search_results')), array (  '_controller' => 'web_profiler.controller.profiler:searchResultsAction',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if (preg_match('#^/_profiler/(?P<token>[^/]++)$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => '_profiler')), array (  '_controller' => 'web_profiler.controller.profiler:panelAction',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                            goto not__profiler;
                ...
                if (preg_match('#^/_profiler/(?P<token>[^/]++)/router$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => '_profiler_router')), array (  '_controller' => 'web_profiler.controller.router:panelAction',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if (preg_match('#^/_profiler/(?P<token>[^/]++)/exception$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => '_profiler_exception')), array (  '_controller' => 'web_profiler.controller.exception:showAction',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if (preg_match('#^/_profiler/(?P<token>[^/]++)/exception\\.css$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => '_profiler_exception_css')), array (  '_controller' => 'web_profiler.controller.exception:cssAction',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
        ...
        elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube')) {
            // admin_login
            if ('/mng_hello_ec_cube/login' === $pathinfo) {
            ...
            // admin_homepage
            if ('/mng_hello_ec_cube' === $trimmedPathinfo) {
            ...
            if (0 === strpos($pathinfo, '/mng_hello_ec_cube/s')) {
                // admin_homepage_sale
                if ('/mng_hello_ec_cube/sale_chart' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/se')) {
                    // admin_homepage_nonstock
                    if ('/mng_hello_ec_cube/search_nonstock' === $pathinfo) {
                    ...
                    if ('/mng_hello_ec_cube/search_customer' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/setting/shop')) {
                        // admin_setting_shop_csv
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/setting/shop/csv') && preg_match('#^/mng_hello_ec_cube/setting/shop/csv(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_shop_csv')), array (  'id' => 3,  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\CsvController::index',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                        ...
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/setting/shop/delivery')) {
                            // admin_setting_shop_delivery
                            if ('/mng_hello_ec_cube/setting/shop/delivery' === $pathinfo) {
                            ...
                            if ('/mng_hello_ec_cube/setting/shop/delivery/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/shop/delivery/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_shop_delivery_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\DeliveryController::edit',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                if (!isset($requiredSchemes[$context->getScheme()])) {
                                    if ('GET' !== $canonicalMethod) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/shop/delivery/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_shop_delivery_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\DeliveryController::delete',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/shop/delivery/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_shop_delivery_visibility')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\DeliveryController::visibility',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            ...
                            if ('/mng_hello_ec_cube/setting/shop/delivery/sort_no/move' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/setting/shop/mail')) {
                            // admin_setting_shop_mail
                            if ('/mng_hello_ec_cube/setting/shop/mail' === $pathinfo) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/shop/mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_shop_mail_edit')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\MailController::index',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                if (!isset($requiredSchemes[$context->getScheme()])) {
                                    if ('GET' !== $canonicalMethod) {
                            ...
                            if ('/mng_hello_ec_cube/setting/shop/mail/preview' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/setting/shop/payment')) {
                            // admin_setting_shop_payment
                            if ('/mng_hello_ec_cube/setting/shop/payment' === $pathinfo) {
                            ...
                            if ('/mng_hello_ec_cube/setting/shop/payment/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/shop/payment/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_shop_payment_edit')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\PaymentController::edit',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                if (!isset($requiredSchemes[$context->getScheme()])) {
                                    if ('GET' !== $canonicalMethod) {
                            ...
                            if ('/mng_hello_ec_cube/setting/shop/payment/image/add' === $pathinfo) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/shop/payment/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_shop_payment_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\PaymentController::delete',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                                if (!in_array($requestMethod, array('DELETE'))) {
                                    if ($hasRequiredScheme) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/shop/payment/(?P<id>\\d+)/visible$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_shop_payment_visible')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\PaymentController::visible',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                                if (!in_array($requestMethod, array('PUT'))) {
                                    if ($hasRequiredScheme) {
                            ...
                            if ('/mng_hello_ec_cube/setting/shop/payment/sort_no/move' === $pathinfo) {
                        ...
                        // admin_setting_shop
                        if ('/mng_hello_ec_cube/setting/shop' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/setting/shop/tax')) {
                            // admin_setting_shop_tax
                            if ('/mng_hello_ec_cube/setting/shop/tax' === $pathinfo) {
                            ...
                            if ('/mng_hello_ec_cube/setting/shop/tax/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/shop/tax/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_shop_tax_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\Shop\\TaxRuleController::delete',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                                if (!in_array($requestMethod, array('DELETE'))) {
                                    if ($hasRequiredScheme) {
                    ...
                    elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/setting/system')) {
                        // admin_setting_system_authority
                        if ('/mng_hello_ec_cube/setting/system/authority' === $pathinfo) {
                        ...
                        if ('/mng_hello_ec_cube/setting/system/log' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/setting/system/masterdata')) {
                            // admin_setting_system_masterdata
                            if ('/mng_hello_ec_cube/setting/system/masterdata' === $pathinfo) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/system/masterdata/(?P<entity>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_system_masterdata_view')), array (  'entity' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\System\\MasterdataController::index',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                if (!isset($requiredSchemes[$context->getScheme()])) {
                                    if ('GET' !== $canonicalMethod) {
                            ...
                            if ('/mng_hello_ec_cube/setting/system/masterdata/edit' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/setting/system/member')) {
                            // admin_setting_system_member
                            if ('/mng_hello_ec_cube/setting/system/member' === $pathinfo) {
                            ...
                            if ('/mng_hello_ec_cube/setting/system/member/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/system/member/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_system_member_edit')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\System\\MemberController::edit',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                if (!isset($requiredSchemes[$context->getScheme()])) {
                                    if ('GET' !== $canonicalMethod) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/system/member/(?P<id>\\d+)/up$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_system_member_up')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\System\\MemberController::up',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                                if (!in_array($requestMethod, array('PUT'))) {
                                    if ($hasRequiredScheme) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/system/member/(?P<id>\\d+)/down$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_system_member_down')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\System\\MemberController::down',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                                if (!in_array($requestMethod, array('PUT'))) {
                                    if ($hasRequiredScheme) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/setting/system/member/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_setting_system_member_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Setting\\System\\MemberController::delete',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                                if (!in_array($requestMethod, array('DELETE'))) {
                                    if ($hasRequiredScheme) {
                        ...
                        if ('/mng_hello_ec_cube/setting/system/security' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/setting/system/system')) {
                            // admin_setting_system_system
                            if ('/mng_hello_ec_cube/setting/system/system' === $pathinfo) {
                            ...
                            if ('/mng_hello_ec_cube/setting/system/system/phpinfo' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/shipping')) {
                    // admin_shipping_update_order_status
                    if (preg_match('#^/mng_hello_ec_cube/shipping/(?P<id>\\d+)/order_status$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_shipping_update_order_status')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Order\\OrderController::updateOrderStatus',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('PUT'))) {
                            if ($hasRequiredScheme) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/shipping/(?P<id>\\d+)/tracking_number$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_shipping_update_tracking_number')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Order\\OrderController::updateTrackingNumber',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('PUT'))) {
                            if ($hasRequiredScheme) {
                    ...
                    // admin_shipping_edit
                    if (preg_match('#^/mng_hello_ec_cube/shipping/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_shipping_edit')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Order\\ShippingController::index',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                    ...
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/shipping/preview_notify_mail') && preg_match('#^/mng_hello_ec_cube/shipping/preview_notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_shipping_preview_notify_mail')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Order\\ShippingController::previewShippingNotifyMail',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                    ...
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/shipping/notify_mail') && preg_match('#^/mng_hello_ec_cube/shipping/notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_shipping_notify_mail')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Order\\ShippingController::notifyMail',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('PUT'))) {
                            if ($hasRequiredScheme) {
                ...
                elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/store/plugin')) {
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/store/plugin/api')) {
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/store/plugin/api/search')) {
                            // admin_store_plugin_owners_search
                            if ('/mng_hello_ec_cube/store/plugin/api/search' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/mng_hello_ec_cube/store/plugin/api/search/page') && preg_match('#^/mng_hello_ec_cube/store/plugin/api/search/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_store_plugin_owners_search_page')), array (  'page_no' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Store\\OwnerStoreController::search',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                if (!isset($requiredSchemes[$context->getScheme()])) {
                                    if ('GET' !== $canonicalMethod) {
                        ...
                        if ('/mng_hello_ec_cube/store/plugin/api/schema_update' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/store/plugin/api/install')) {
                            // admin_store_plugin_install_confirm
                            if (preg_match('#^/mng_hello_ec_cube/store/plugin/api/install/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_store_plugin_install_confirm')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Store\\OwnerStoreController::doConfirm',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                if (!isset($requiredSchemes[$context->getScheme()])) {
                                    if ('GET' !== $canonicalMethod) {
                            ...
                            if ('/mng_hello_ec_cube/store/plugin/api/install' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/store/plugin/api/delete') && preg_match('#^/mng_hello_ec_cube/store/plugin/api/delete/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_store_plugin_api_uninstall')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Store\\OwnerStoreController::apiUninstall',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, array('DELETE'))) {
                                if ($hasRequiredScheme) {
                        ...
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/store/plugin/api/upgrade')) {
                            // admin_store_plugin_api_upgrade
                            if ('/mng_hello_ec_cube/store/plugin/api/upgrade' === $pathinfo) {
                            ...
                            if (preg_match('#^/mng_hello_ec_cube/store/plugin/api/upgrade/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_store_plugin_update_confirm')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Store\\OwnerStoreController::doUpdateConfirm',));
                                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                                if (!isset($requiredSchemes[$context->getScheme()])) {
                                    if ('GET' !== $canonicalMethod) {
                        ...
                        if ('/mng_hello_ec_cube/store/plugin/api/update' === $pathinfo) {
                    ...
                    // admin_store_plugin
                    if ('/mng_hello_ec_cube/store/plugin' === $pathinfo) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/store/plugin/(?P<id>\\d+)/update$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_store_plugin_update')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Store\\PluginController::update',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('POST'))) {
                            if ($hasRequiredScheme) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/store/plugin/(?P<id>\\d+)/enable$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_store_plugin_enable')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Store\\PluginController::enable',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('POST'))) {
                            if ($hasRequiredScheme) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/store/plugin/(?P<id>\\d+)/disable$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_store_plugin_disable')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Store\\PluginController::disable',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('POST'))) {
                            if ($hasRequiredScheme) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/store/plugin/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_store_plugin_uninstall')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Store\\PluginController::uninstall',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('DELETE'))) {
                            if ($hasRequiredScheme) {
                    ...
                    if ('/mng_hello_ec_cube/store/plugin/install' === $pathinfo) {
                    ...
                    if ('/mng_hello_ec_cube/store/plugin/authentication_setting' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/store/template')) {
                    // admin_store_template
                    if ('/mng_hello_ec_cube/store/template' === $pathinfo) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/store/template/(?P<id>\\d+)/download$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_store_template_download')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Store\\TemplateController::download',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/store/template/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_store_template_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Store\\TemplateController::delete',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('DELETE'))) {
                            if ($hasRequiredScheme) {
                    ...
                    if ('/mng_hello_ec_cube/store/template/install' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/c')) {
                // admin_change_password
                if ('/mng_hello_ec_cube/change_password' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/content')) {
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/content/block')) {
                        // admin_content_block
                        if ('/mng_hello_ec_cube/content/block' === $pathinfo) {
                        ...
                        if ('/mng_hello_ec_cube/content/block/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/content/block/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_block_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Content\\BlockController::edit',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/content/block/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_block_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Content\\BlockController::delete',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, array('DELETE'))) {
                                if ($hasRequiredScheme) {
                    ...
                    // admin_content_cache
                    if ('/mng_hello_ec_cube/content/cache' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/content/file_')) {
                        // admin_content_file
                        if ('/mng_hello_ec_cube/content/file_manager' === $pathinfo) {
                        ...
                        if ('/mng_hello_ec_cube/content/file_view' === $pathinfo) {
                        ...
                        if ('/mng_hello_ec_cube/content/file_delete' === $pathinfo) {
                        ...
                        if ('/mng_hello_ec_cube/content/file_download' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/content/layout')) {
                        // admin_content_layout
                        if ('/mng_hello_ec_cube/content/layout' === $pathinfo) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/content/layout/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_layout_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Content\\LayoutController::delete',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, array('DELETE'))) {
                                if ($hasRequiredScheme) {
                        ...
                        if ('/mng_hello_ec_cube/content/layout/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/content/layout/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_layout_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Content\\LayoutController::edit',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                        ...
                        if ('/mng_hello_ec_cube/content/layout/view_block' === $pathinfo) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/content/layout/(?P<id>\\d+)/preview$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_layout_preview')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Content\\LayoutController::preview',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                    ...
                    elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/content/news')) {
                        // admin_content_news
                        if ('/mng_hello_ec_cube/content/news' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/content/news/page') && preg_match('#^/mng_hello_ec_cube/content/news/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_news_page')), array (  'page_no' => 1,  '_controller' => 'Eccube\\Controller\\Admin\\Content\\NewsController::index',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                        ...
                        if ('/mng_hello_ec_cube/content/news/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/content/news/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_news_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Content\\NewsController::edit',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/content/news/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_news_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Content\\NewsController::delete',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, array('DELETE'))) {
                                if ($hasRequiredScheme) {
                    ...
                    elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/content/page')) {
                        // admin_content_page
                        if ('/mng_hello_ec_cube/content/page' === $pathinfo) {
                        ...
                        if ('/mng_hello_ec_cube/content/page/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/content/page/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_page_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Content\\PageController::edit',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/content/page/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_content_page_delete')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Content\\PageController::delete',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, array('DELETE'))) {
                                if ($hasRequiredScheme) {
                ...
                elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/customer')) {
                    // admin_customer
                    if ('/mng_hello_ec_cube/customer' === $pathinfo) {
                    ...
                    // admin_customer_page
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/customer/page') && preg_match('#^/mng_hello_ec_cube/customer/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_customer_page')), array (  'page_no' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Customer\\CustomerController::index',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/customer/(?P<id>\\d+)/resend$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_customer_resend')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Customer\\CustomerController::resend',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/customer/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_customer_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Customer\\CustomerController::delete',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('DELETE'))) {
                            if ($hasRequiredScheme) {
                    ...
                    if ('/mng_hello_ec_cube/customer/export' === $pathinfo) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/customer/(?P<id>\\d+)/delivery/new$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_customer_delivery_new')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Customer\\CustomerDeliveryEditController::edit',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_customer_delivery_edit')), array (  'did' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Customer\\CustomerDeliveryEditController::edit',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_customer_delivery_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Customer\\CustomerDeliveryEditController::delete',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('DELETE'))) {
                            if ($hasRequiredScheme) {
                    ...
                    // admin_customer_new
                    if ('/mng_hello_ec_cube/customer/new' === $pathinfo) {
                    ...
                    // admin_customer_edit
                    if (preg_match('#^/mng_hello_ec_cube/customer/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_customer_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Customer\\CustomerEditController::index',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
            ...
            elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/order')) {
                // admin_shipping_csv_import
                if ('/mng_hello_ec_cube/order/shipping_csv_upload' === $pathinfo) {
                ...
                if ('/mng_hello_ec_cube/order/csv_template' === $pathinfo) {
                ...
                // admin_order_new
                if ('/mng_hello_ec_cube/order/new' === $pathinfo) {
                ...
                // admin_order_edit
                if (preg_match('#^/mng_hello_ec_cube/order/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Order\\EditController::index',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/order/search')) {
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/order/search/customer/html')) {
                        // admin_order_search_customer_html
                        if ('/mng_hello_ec_cube/order/search/customer/html' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/order/search/customer/html/page') && preg_match('#^/mng_hello_ec_cube/order/search/customer/html/page(?:/(?P<page_no>[^/]++))?$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_search_customer_html_page')), array (  'page_no' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Order\\EditController::searchCustomerHtml',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                    ...
                    if ('/mng_hello_ec_cube/order/search/customer/id' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/order/search/product')) {
                        // admin_order_search_product
                        if ('/mng_hello_ec_cube/order/search/product' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/mng_hello_ec_cube/order/search/product/page') && preg_match('#^/mng_hello_ec_cube/order/search/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_search_product_page')), array (  'page_no' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Order\\EditController::searchProduct',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                    ...
                    if ('/mng_hello_ec_cube/order/search/order_item_type' === $pathinfo) {
                ...
                // admin_order_mail
                if (preg_match('#^/mng_hello_ec_cube/order/(?P<id>\\d+)/mail$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_mail')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Order\\MailController::index',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if ('/mng_hello_ec_cube/order/mail/view' === $pathinfo) {
                ...
                // admin_order
                if ('/mng_hello_ec_cube/order' === $pathinfo) {
                ...
                // admin_order_page
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/order/page') && preg_match('#^/mng_hello_ec_cube/order/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_page')), array (  'page_no' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Order\\OrderController::index',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if ('/mng_hello_ec_cube/order/bulk_delete' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/order/export')) {
                    // admin_order_export_order
                    if ('/mng_hello_ec_cube/order/export/order' === $pathinfo) {
                    ...
                    if ('/mng_hello_ec_cube/order/export/shipping' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/order/export/pdf')) {
                        // admin_order_export_pdf
                        if ('/mng_hello_ec_cube/order/export/pdf' === $pathinfo) {
                        ...
                        if ('/mng_hello_ec_cube/order/export/pdf/download' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/product')) {
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/product/c')) {
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/product/category')) {
                        // admin_product_category
                        if ('/mng_hello_ec_cube/product/category' === $pathinfo) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/product/category(?:/(?P<parent_id>\\d+))?$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_category_show')), array (  'parent_id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Product\\CategoryController::index',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/product/category/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_category_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Product\\CategoryController::index',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/product/category/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_category_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Product\\CategoryController::delete',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, array('DELETE'))) {
                                if ($hasRequiredScheme) {
                        ...
                        if ('/mng_hello_ec_cube/product/category/sort_no/move' === $pathinfo) {
                        ...
                        if ('/mng_hello_ec_cube/product/category/export' === $pathinfo) {
                        ...
                        if ('/mng_hello_ec_cube/product/category_csv_upload' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/product/class_category')) {
                        // admin_product_class_category
                        if (preg_match('#^/mng_hello_ec_cube/product/class_category/(?P<class_name_id>\\d+)$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_class_category')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ClassCategoryController::index',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_class_category_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ClassCategoryController::index',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_class_category_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ClassCategoryController::delete',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, array('DELETE'))) {
                                if ($hasRequiredScheme) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_class_category_visibility')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ClassCategoryController::visibility',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, array('PUT'))) {
                                if ($hasRequiredScheme) {
                        ...
                        if ('/mng_hello_ec_cube/product/class_category/sort_no/move' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/mng_hello_ec_cube/product/class_name')) {
                        // admin_product_class_name
                        if ('/mng_hello_ec_cube/product/class_name' === $pathinfo) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/product/class_name/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_class_name_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ClassNameController::index',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                        ...
                        if (preg_match('#^/mng_hello_ec_cube/product/class_name/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_class_name_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ClassNameController::delete',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, array('DELETE'))) {
                                if ($hasRequiredScheme) {
                        ...
                        if ('/mng_hello_ec_cube/product/class_name/sort_no/move' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/mng_hello_ec_cube/product/csv_template') && preg_match('#^/mng_hello_ec_cube/product/csv_template/(?P<type>\\w+)$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_csv_template')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Product\\CsvImportController::csvTemplate',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                ...
                if ('/mng_hello_ec_cube/product/product_csv_upload' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/product/product/class')) {
                    // admin_product_product_class
                    if (preg_match('#^/mng_hello_ec_cube/product/product/class/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_product_class')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductClassController::index',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/product/product/class/(?P<id>\\d+)/clear$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_product_class_clear')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductClassController::clearProductClasses',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                ...
                // admin_product
                if ('/mng_hello_ec_cube/product' === $pathinfo) {
                ...
                // admin_product_page
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/product/page') && preg_match('#^/mng_hello_ec_cube/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_page')), array (  'page_no' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductController::index',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/product/product')) {
                    // admin_product_image_add
                    if ('/mng_hello_ec_cube/product/product/image/add' === $pathinfo) {
                    ...
                    if ('/mng_hello_ec_cube/product/product/new' === $pathinfo) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/product/product/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_product_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductController::edit',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/product/product/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_product_delete')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductController::delete',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('DELETE'))) {
                            if ($hasRequiredScheme) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/product/product/(?P<id>\\d+)/copy$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_product_copy')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductController::copy',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('POST'))) {
                            if ($hasRequiredScheme) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/product/product/(?P<id>\\d+)/display$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_product_display')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductController::display',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                ...
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/product/classes') && preg_match('#^/mng_hello_ec_cube/product/classes/(?P<id>\\d+)/load$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_classes_load')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductController::loadProductClasses',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                    if (!in_array($canonicalMethod, array('GET'))) {
                        if ($hasRequiredScheme) {
                ...
                if ('/mng_hello_ec_cube/product/export' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/product/bulk/product-status') && preg_match('#^/mng_hello_ec_cube/product/bulk/product\\-status/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_bulk_product_status')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Product\\ProductController::bulkProductStatus',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                    if (!in_array($requestMethod, array('POST'))) {
                        if ($hasRequiredScheme) {
                ...
                if (0 === strpos($pathinfo, '/mng_hello_ec_cube/product/tag')) {
                    // admin_product_tag
                    if ('/mng_hello_ec_cube/product/tag' === $pathinfo) {
                    ...
                    if (preg_match('#^/mng_hello_ec_cube/product/tag/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_product_tag_delete')), array (  '_controller' => 'Eccube\\Controller\\Admin\\Product\\TagController::delete',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, array('DELETE'))) {
                            if ($hasRequiredScheme) {
                    ...
                    if ('/mng_hello_ec_cube/product/tag/sort_no/move' === $pathinfo) {
            ...
            // admin_logout
            if ('/mng_hello_ec_cube/logout' === $pathinfo) {
                $ret = array('_route' => 'admin_logout');
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
        ...
        elseif (0 === strpos($pathinfo, '/mypage')) {
            ...
            elseif (0 === strpos($pathinfo, '/mypage/delivery')) {
                ...
                if (preg_match('#^/mypage/delivery/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'mypage_delivery_edit')), array (  'id' => NULL,  '_controller' => 'Eccube\\Controller\\Mypage\\DeliveryController::edit',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if (preg_match('#^/mypage/delivery/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'mypage_delivery_delete')), array (  '_controller' => 'Eccube\\Controller\\Mypage\\DeliveryController::delete',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                    if (!in_array($requestMethod, array('DELETE'))) {
                        if ($hasRequiredScheme) {
            ...
            if (0 === strpos($pathinfo, '/mypage/history') && preg_match('#^/mypage/history/(?P<order_no>[^/]++)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'mypage_history')), array (  '_controller' => 'Eccube\\Controller\\Mypage\\MypageController::history',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
            ...
            if (0 === strpos($pathinfo, '/mypage/order') && preg_match('#^/mypage/order/(?P<order_no>[^/]++)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'mypage_order')), array (  '_controller' => 'Eccube\\Controller\\Mypage\\MypageController::order',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                if (!in_array($requestMethod, array('PUT'))) {
                    if ($hasRequiredScheme) {
            ...
            if (0 === strpos($pathinfo, '/mypage/favorite')) {
                ...
                if (preg_match('#^/mypage/favorite/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'mypage_favorite_delete')), array (  '_controller' => 'Eccube\\Controller\\Mypage\\MypageController::delete',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                    if (!in_array($requestMethod, array('DELETE'))) {
                        if ($hasRequiredScheme) {
        ...
        elseif (0 === strpos($pathinfo, '/cart')) {
            ...
            if (preg_match('#^/cart/(?P<operation>up|down|remove)/(?P<productClassId>\\d+)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'cart_handle_item')), array (  '_controller' => 'Eccube\\Controller\\CartController::handleCartItem',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                if (!in_array($requestMethod, array('PUT'))) {
                    if ($hasRequiredScheme) {
            ...
            // cart_buystep
            if (0 === strpos($pathinfo, '/cart/buystep') && preg_match('#^/cart/buystep/(?P<cart_key>[a-zA-Z0-9]+[_]\\d+)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'cart_buystep')), array (  '_controller' => 'Eccube\\Controller\\CartController::buystep',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
        ...
        elseif (0 === strpos($pathinfo, '/entry')) {
            ...
            if (0 === strpos($pathinfo, '/entry/activate') && preg_match('#^/entry/activate/(?P<secret_key>[^/]++)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'entry_activate')), array (  '_controller' => 'Eccube\\Controller\\EntryController::activate',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
        ...
        elseif (0 === strpos($pathinfo, '/forgot')) {
            ...
            if (0 === strpos($pathinfo, '/forgot/reset') && preg_match('#^/forgot/reset/(?P<reset_key>[^/]++)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'forgot_reset')), array (  '_controller' => 'Eccube\\Controller\\ForgotController::reset',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
        ...
        elseif (0 === strpos($pathinfo, '/shopping')) {
            ...
            elseif (0 === strpos($pathinfo, '/shopping/shipping')) {
                ...
                if (preg_match('#^/shopping/shipping/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'shopping_shipping')), array (  '_controller' => 'Eccube\\Controller\\ShoppingController::shipping',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
                ...
                if (0 === strpos($pathinfo, '/shopping/shipping_edit') && preg_match('#^/shopping/shipping_edit/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'shopping_shipping_edit')), array (  '_controller' => 'Eccube\\Controller\\ShoppingController::shippingEdit',));
                    $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                    if (!isset($requiredSchemes[$context->getScheme()])) {
                        if ('GET' !== $canonicalMethod) {
        ...
        elseif (0 === strpos($pathinfo, '/products')) {
            ...
            if (0 === strpos($pathinfo, '/products/detail') && preg_match('#^/products/detail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'product_detail')), array (  '_controller' => 'Eccube\\Controller\\ProductController::detail',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                if (!in_array($canonicalMethod, array('GET'))) {
                    if ($hasRequiredScheme) {
            ...
            if (0 === strpos($pathinfo, '/products/add_favorite') && preg_match('#^/products/add_favorite/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'product_add_favorite')), array (  '_controller' => 'Eccube\\Controller\\ProductController::addFavorite',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
            ...
            if (0 === strpos($pathinfo, '/products/add_cart') && preg_match('#^/products/add_cart/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'product_add_cart')), array (  '_controller' => 'Eccube\\Controller\\ProductController::addCart',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                if (!in_array($requestMethod, array('POST'))) {
                    if ($hasRequiredScheme) {
        ...
        if (0 === strpos($pathinfo, '/user_data') && preg_match('#^/user_data/(?P<route>([0-9a-zA-Z_\\-]+\\/?)+(?<!\\/))$#sD', $pathinfo, $matches)) {
            $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'user_data')), array (  '_controller' => 'Eccube\\Controller\\UserDataController::index',));
            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
            if (!isset($requiredSchemes[$context->getScheme()])) {
                if ('GET' !== $canonicalMethod) {
                    goto not_user_data;
